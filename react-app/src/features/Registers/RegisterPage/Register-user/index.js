...
import InputField from '../../../Component/inputReg';
import Button from '../../../Component/Botton';
import PreviousButton from "../../../Component/previousbttn"

const RegisterUser = () => {
    const handleButtonClick = () => {
        // Define the action you want when the button is clicked
        ...
        <div className="container">
            ...
            <div className="left-content">
                <PreviousButton href="#" />
                    ...
                    <InputField placeholder="ชื่อร้านค้า" type="text"/>
                    ...
                    <InputField placeholder="เว็ปไซต์ร้านค้า" type="text"/>

                    <div className="input-container">
                        <input type="text" placeholder="ที่อยู่" />
                    </div>

                    <InputField placeholder="ที่อยู่" type="text"/>
